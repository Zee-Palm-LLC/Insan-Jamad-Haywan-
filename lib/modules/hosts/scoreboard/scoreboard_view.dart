...
import 'package:insan_jamd_hawan/modules/hosts/scoreboard/components/first_position_podium.dart';
...
class _ScoreboardViewState extends State<ScoreboardView>
  ...
  final List<Map<String, dynamic>> _shownPlayers = [];
  ...
  Future<void> _simulateAppearing() async {
    for (final player in _players) {
      ...
      if (mounted) {
        setState(() => _shownPlayers.add(player));
      }
    }
  }
